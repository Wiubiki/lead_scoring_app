...
credentials = {
    "admin": b"$2b$12$stKOH.ZarvtSMIhzd9miVuYExQYmrzqyP7TB0y3BRbkihAwLXuC.y",  # Hash for "mypassword123"
    ...
    "guest": b"$2b$12$/Opf7JIp7qvgI0SNcVVA/uTFIxMRDJpH5sJ/uxi/k6B92XgN19u.e"  # Replace with another hash
}
